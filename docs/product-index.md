...
共 **205 个产品（SKU 去重）**，其中 146 个有图片、59 个缺图片；55 个被多条产品线复用；线材 68 个中 68 个已识别出线长。
...
| c6lite20 | C6 Lite 2_0 | 18 | 5 | [有](knowledge/c6-lite-2.0.md) |
| m1n20 | M1N 2_0 | 35 | 2 | [有](knowledge/m1n-2.0.md) |
...
| 5152178100017 | 966C46-IPC kit | 1080P · 966C46-IPC kit | ✅ 1张 | 966c46ipc#2 |
...
| 5154022100006 | C6 Lite 2.0 Kit 套装 | 1080P · North America Version 北美版本 | ❌ | c6lite20#7 |
| 5154022100020 | C6 Lite 2.0-S Kit套装 | 1080P · North America Version 北美版本 | ❌ | c6lite20#8 |
...
| 1261050100344 | IPC Video Expansion Cable IPC/CAN2线 | 0.25m · Required for connecting the second IPC a… | ❌ | m1n20#5 |
...
| 5151047100028 | CA29P | 720P · 720P, NTSC, Streamax Logo. Vertical moun… | ✅ 2张 | c6lite20#20; f6n#15 |
...
| 5151053100002 | CA46 | 1080P · AHD, PAL. Choose based on requirements A… | ✅ 2张 | gt1prodcmax#49; m3n#16 |
...
| SKU | 名称 | 规格 | 图片 | 使用位置（产品线#行号） |
| --- | --- | --- | --- | --- |
| For specific part numbers, refer to the memory device recommendation table 具体料号参考存储器件推荐表 | Micro SD Card | Selected according to project requiremen… | ✅ 1张 | adplus20#51 |
| Specific Part Number Refer to Storage Device Recommendation List | Micro SD Card | Choose based on project requirements 根据项… | ✅ 6张 | gt1prodcmax#79; m1n20#37,38; m3n#37,38; f6n#40 |
| Refer to specific part number in the device storage recommendation table | Micro SD Card | Choose based on the requirements 根据项目需求选… | ✅ 1张 | c6lite20#24 |
...
| 5154022100006 | C6 Lite 2.0 Kit 套装 | 核心套装 | c6lite20#7 |
| 5154022100020 | C6 Lite 2.0-S Kit套装 | 核心套装 | c6lite20#8 |
...
| 1261050100344 | IPC Video Expansion Cable IPC/CAN2线 | 线材 | m1n20#5 |
